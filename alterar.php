...
<body>
    ...
    <?php 
    include("conexao.php");
    $cliente = selectCliente($_POST['id']);
    ?>
    ...
    <form action="conexao.php" class="" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="nome" id="nome" value="<?=$cliente['nome']?>" class="form-control col-sm-7" >
        </div>
        
        <div class="form-row">
            <div class="col-sm-3">
                <label for="telefone">Telefone</label>
                <input type="tel" name="telefone" value="<?=$cliente['telefone']?>" id="telefone" class="form-control" >
            </div>

            <div class="col-sm-3">
                <label for="email">E-mail</label>
                <input type="email" name="email" value="<?=$cliente['email']?>" id="email"  class="form-control" >
            </div>
        </div>
        ...
        <div class="form-row mt-2">
            <div class="col-sm-3">
                ...
                <input type="text" name="nascimento" value="<?=$cliente['nascimento']?>" id="nascimento"   class="form-control" >
            </div>

            <div class="col-sm-2">
                <label for="sexo">Sexo</label>
                <select class="form-control" value="<?=$cliente['sexo']?>" name="sexo" id="sexo">
